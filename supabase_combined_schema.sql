...
-- Grant execute on external/conditional functions (wrapped in safety DO blocks to prevent errors on fresh/empty DB schemas)
DO $$ BEGIN
  EXECUTE 'GRANT EXECUTE ON FUNCTION public.secure_check_in TO authenticated';
EXCEPTION WHEN OTHERS THEN NULL; END $$;

DO $$ BEGIN
  EXECUTE 'GRANT EXECUTE ON FUNCTION public.upsert_rsvp_tier TO authenticated';
EXCEPTION WHEN OTHERS THEN NULL; END $$;

DO $$ BEGIN
  EXECUTE 'GRANT EXECUTE ON FUNCTION public.generate_ticket_token TO authenticated';
EXCEPTION WHEN OTHERS THEN NULL; END $$;

DO $$ BEGIN
  EXECUTE 'GRANT EXECUTE ON FUNCTION public.increment_wallet_balance TO authenticated';
EXCEPTION WHEN OTHERS THEN NULL; END $$;

DO $$ BEGIN
  EXECUTE 'GRANT EXECUTE ON FUNCTION public.update_sis_score TO authenticated';
EXCEPTION WHEN OTHERS THEN NULL; END $$;

DO $$ BEGIN
  EXECUTE 'GRANT EXECUTE ON FUNCTION public.refresh_trending_events TO authenticated';
EXCEPTION WHEN OTHERS THEN NULL; END $$;
