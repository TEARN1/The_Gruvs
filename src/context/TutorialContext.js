...
export const TUTORIALS = [
  ...
  },
  {
    ...
    steps: [
      {
        icon: 'shield',
        title: 'Viper vs Incognito Mode',
        body: 'The Gruvs has two identity modes. Viper is your public Vibe — visible, social, stacking. Incognito is your private mode — anonymous, ad-free, untraceable. Switch instantly from your Vibe Card.',
      ...
      },
      {
        ...
        tip: 'In Incognito Mode you still stack Vibe Score — it accumulates privately.',
        visual: 'celebrity',
      },
    ],
  },
  ...
  },
  {
    ...
    steps: [
      ...
      {
        icon: 'eye-off',
        title: 'Mission-Free in Incognito Mode',
        body: "Switch to Incognito Mode from your Vibe Card to browse The Gruvs completely Mission-free. All contextual Missions and promoted campaigns are hidden while you're in Incognito Mode.",
        tip: 'Incognito Mode is free for all Vibers — no subscription required.',
        visual: 'adfree',
      },
    ],
  },
  ...
  // ── Lineup & Pings ───────────────────────────────────────────────────────────
  {
    ...
    steps: [
      ...
      },
      {
        ...
        tip: "In Incognito Mode, your Lineup is private and can't be Dropped to others.",
        visual: 'share_cal',
      },
    ],
  },
