...
const styles = StyleSheet.create({
  ...
  joinBtn: { width: '100%', backgroundColor: ACCENT, paddingVertical: 18, borderRadius: 20, alignItems: 'center', marginBottom: 15, shadowColor: ACCENT, shadowOpacity: 0.4, shadowRadius: 10, elevation: 8 },
