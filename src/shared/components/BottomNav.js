...
const NAV_ITEMS = [
    { id: 'feed', icon: '🏠', label: 'Pulse' },
    { id: 'explore', icon: '🔍', label: 'Explore' },
    { id: 'add_event', icon: '➕', special: true },
    { id: 'messages', icon: '💬', label: 'Waves' },
...
const styles = StyleSheet.create({
    ...
    specialItem: {
        ...
        marginTop: -30,
        ...Platform.select({
            web: { boxShadow: '0 4px 10px rgba(255, 77, 166, 0.5)' },
            default: { shadowColor: '#ff4da6', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.5, shadowRadius: 10, elevation: 10 }
        })
    },
    specialIcon: {
        color: '#fff',
