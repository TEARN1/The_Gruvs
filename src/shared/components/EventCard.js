...
import { View, Text, TouchableOpacity, StyleSheet, Image, TextInput, useWindowDimensions, Platform } from 'react-native';
...
export function EventCard({ post, theme, onPress, onLike, onRSVP }) {
    ...
    const mediaItems = content.media || [
        { type: 'image', url: 'https://images.unsplash.com/photo-1514525253361-bee243870e2e?auto=format&fit=crop&q=80&w=800' },
        { type: 'image', url: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&q=80&w=800' }
    ];
            ...
            <TouchableOpacity onPress={onPress} style={[styles.contentBody, isMobile && { paddingHorizontal: 15 }]}>
                ...
                <View style={[styles.mediaCarousel, isMobile && { height: 200 }]}>
                    <View style={[styles.mediaPlaceholder, isMobile && { height: 200 }]}>
                        <Image 
                            source={{ uri: mediaItems[currentMediaIdx].url }} 
...
const styles = StyleSheet.create({
    ...
    cardGlow: {
        borderColor: '#ffcc00',
        ...Platform.select({
            web: { boxShadow: '0 0 20px #ffcc00' },
            default: { shadowColor: '#ffcc00', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.8, shadowRadius: 20, elevation: 20 }
        }),
    ...
    followingBtn: {
        backgroundColor: '#ff4da6', // Default accent if theme.accent fails
    },
    ...
    mediaText: { color: 'rgba(255,255,255,0.8)', fontSize: 14, fontWeight: '800', textAlign: 'center' },
    mediaPagination: {
        position: 'absolute',
        top: 20,
        right: 20,
