      ...
      <View style={styles.sheet}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Text style={styles.secureText}>
            <Ionicons name="lock-closed" size={11} color={THEME.sub} /> Secured by Enterprise Firewall
          </Text>
        </ScrollView>
      </View>
    </Modal>
...
const styles = StyleSheet.create({
  ...
  eventVenue: { color: THEME.sub, fontSize: 13, marginTop: 4 },
  ...
  modeText: { color: THEME.sub, fontSize: 14, fontWeight: '700' },
  ...
  ticketPrice: { color: THEME.sub, fontSize: 14, marginTop: 4 },
  ...
  bidLabel: { color: THEME.sub, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 10 },
  ...
  payBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, backgroundColor: '#fff', paddingVertical: 18, borderRadius: 16, shadowColor: '#fff', shadowOpacity: 0.2, shadowRadius: 10 },
  payBtnGold: { backgroundColor: GOLD, shadowColor: GOLD },
  payBtnText: { color: '#000', fontSize: 16, fontWeight: '900' },
  secureText: { color: THEME.sub, fontSize: 11, textAlign: 'center', marginTop: 14, fontWeight: '600' }
});
