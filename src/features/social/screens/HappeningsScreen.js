...
export default function HappeningsScreen({ navigation }) {
    ...
    const { posts, addEventModalVisible, setAddEventModalVisible, fetchPosts, subscribeToEvents, user } = useStore();
    ...
    const contentWidth = isMobile ? width : Math.min(width, 700);
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: THEME.bg }]}>
            <View style={[styles.contentWrapper, { width: contentWidth, alignSelf: 'center' }]}>
                <View style={[styles.header, { paddingHorizontal: width < 600 ? 12 : 20 }]}>
                    ...
                    <TouchableOpacity onPress={openAddEvent} style={styles.headerBtn}>
