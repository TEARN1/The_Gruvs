...
import { View, Text, StyleSheet, ScrollView, SafeAreaView, TouchableOpacity, Image, Platform, TextInput, KeyboardAvoidingView, Share, Dimensions, Alert } from 'react-native';
...
export default function EventDetailScreen({ route, navigation }) {
    ...
    const handleRSVPWithAuth = (id, status) => {
            ...
            <SafeAreaView style={styles.safeArea}>
                        ...
                        <View style={[styles.actionRow, Platform.OS === 'web' && { flexDirection: 'column' }]}>
                            <View style={[styles.btnStack, Platform.OS === 'web' && { width: '100%' }]}>
                                <TouchableOpacity 
                                    ...
                                    onPress={() => handleRSVPWithAuth(event.id, 'going')}
                                >
                                ...
                                <TouchableOpacity style={styles.secondaryBtn} onPress={() => {
                                    ...
                                    triggerHaptic('medium');
                                    Alert.alert('Coming Soon', 'Ticket purchasing in the Vault is launching soon!');
                                }}>
                ...
                <View style={styles.chatInputContainer}>
                    ...
                    <TouchableOpacity 
                        ...
                        onPress={handleSendMessageWithAuth}
...
const styles = StyleSheet.create({
    ...
    mainBtn: { height: width < 600 ? 50 : 60, borderRadius: 20, justifyContent: 'center', alignItems: 'center', ...Platform.select({ web: { boxShadow: `0 8px 10px rgba(0,0,0,0.3)` }, default: { shadowColor: '#000', shadowOpacity: 0.3, shadowRadius: 10, elevation: 5 } }) },
