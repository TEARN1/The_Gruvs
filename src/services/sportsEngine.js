...
export const SPORT_REGISTRY = {
  ...
  esports: {
    ...
    disciplines: ['EA FC / FIFA','Call of Duty','Fortnite','Valorant','Apex Legends','PUBG','Dota 2','League of Legends','CS2','Overwatch','Rocket League','Tekken','Street Fighter','Mortal Kombat','GTA Online','Mobile Legends','Free Fire'],
    event_types: ['round_win','map_win','kill','ace','clutch','objective','mvp'],
