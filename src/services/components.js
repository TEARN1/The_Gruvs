...
const toastStyles = StyleSheet.create({
    ...
    toast: { 
        ...
        minWidth: 220,
        ...Platform.select({
            web: { boxShadow: '0 8px 16px rgba(0,0,0,0.25)' },
            default: { shadowColor: '#000', shadowOpacity: 0.25, shadowRadius: 8, elevation: 8 }
        })
    },
...
const dlgStyles = StyleSheet.create({
    ...
    box: { 
        ...
        ...Platform.select({
            ...
            default: { shadowColor: '#000', shadowOpacity: 0.3, shadowRadius: 20, elevation: 15 }
        })
    },
